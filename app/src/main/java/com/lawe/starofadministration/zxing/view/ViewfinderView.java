...
package com.lawe.starofadministration.zxing.view;
...
public final class ViewfinderView extends View {
  ...
  public ViewfinderView(Context context, AttributeSet attrs) {
    ...
    laserColor = array.getColor(R.styleable.VerificationCodeInputView_laser_color, 0x00FF00);
    cornerColor = array.getColor(R.styleable.VerificationCodeInputView_corner_color, 0x00FF00);
    frameColor = array.getColor(R.styleable.VerificationCodeInputView_frame_color, 0xFFFFFF);
    resultPointColor = array.getColor(R.styleable.VerificationCodeInputView_result_point_color, 0xC0FFFF00);
    maskColor = array.getColor(R.styleable.VerificationCodeInputView_mask_color, 0x60000000);
    resultColor = array.getColor(R.styleable.VerificationCodeInputView_result_color, 0xB0000000);
    labelTextColor = array.getColor(R.styleable.VerificationCodeInputView_label_text_color, 0x90FFFFFF);
    labelText = array.getString(R.styleable.VerificationCodeInputView_label_text);
    labelTextSize = array.getFloat(R.styleable.VerificationCodeInputView_label_text_size, 36f);
