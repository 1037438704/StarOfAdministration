 ...
 * description : 收文传阅---办理文件
 **/
@Layout(R.layout.activity_handled)
@DarkStatusBarTheme(true)           //开启顶部状态栏图标、文字暗色模式
@DarkNavigationBarTheme(true)       //开启底部导航栏按钮暗色模式
@NavigationBarBackgroundColor(a = 255, r = 255, g = 255, b = 255)
public class HandledActivity extends BaseAty {
    ...
    int pageCounte = 0;
    private LinearLayout handledTuiban;
    private LinearLayout handledYanqi;
    private LinearLayout handledBianhan;
    ...
    public void setEvents() {
        ...
        //退办
        handledTuiban.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //1、使用Dialog、设置style
        ...
        //延期
        handledYanqi.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //1、使用Dialog、设置style
                final Dialog dialog = new Dialog(me, R.style.DialogTheme);
    ...
    private void initView() {
        ...
        handledTuiban = findViewById(R.id.handled_tuiban);
        handledYanqi = findViewById(R.id.handled_yanqi);
        handledBianhan = findViewById(R.id.handled_bianhan);
    }
}
