 ...
 * description : 收文传阅---公文批示
 **/
@Layout(R.layout.activity_instructions)
@DarkStatusBarTheme(true)           //开启顶部状态栏图标、文字暗色模式
@DarkNavigationBarTheme(true)       //开启底部导航栏按钮暗色模式
@NavigationBarBackgroundColor(a = 255, r = 255, g = 255, b = 255)
public class InstructionsActivity extends BaseAty {
    ...
    int pageCounte = 0;
    private LinearLayout instruTuiban;
    private LinearLayout instruYanqi;
    ...
    public void setEvents() {
        ...
        //退办
        instruTuiban.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //1、使用Dialog、设置style
        ...
        //延期
        instruYanqi.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //1、使用Dialog、设置style
                final Dialog dialog = new Dialog(me, R.style.DialogTheme);
    ...
    private void initView() {
        ...
        bottomChooseper2.setText("添加承办人");
        bottomWhrit.setHint("请输入批示意见");
        ...
        instruTuiban = findViewById(R.id.instru_tuiban);
        instruYanqi = findViewById(R.id.instru_yanqi);
    }
}
