...
import com.lawe.starofadministration.fgt.gongwen_guidang.FileContextFragment;
import com.lawe.starofadministration.fgt.gongwen_guidang.FileEclosureFragment;
import com.lawe.starofadministration.fgt.gongwen_guidang.FileSettingFragment;
import com.lawe.starofadministration.fgt.gongwen_guidang.FileSpeedFragment;
 ...
 * description : 公文归档---拟制公文归档
 **/
@Layout(R.layout.activity_simulacrum)
@DarkStatusBarTheme(true)           //开启顶部状态栏图标、文字暗色模式
@DarkNavigationBarTheme(true)       //开启底部导航栏按钮暗色模式
@NavigationBarBackgroundColor(a = 255, r = 255, g = 255, b = 255)
public class SimulacrumActivity extends BaseAty {
    ...
    public void initDatas(JumpParameter parameter) {
        ...
        fragemnts.add(FileSettingFragment.newInstance());
        fragemnts.add(FileEclosureFragment.newInstance());
        fragemnts.add(FileContextFragment.newInstance());
        fragemnts.add(FileSpeedFragment.newInstance());
