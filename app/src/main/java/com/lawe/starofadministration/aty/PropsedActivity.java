 ...
 * description : 收文传阅---公文拟办
 **/
@Layout(R.layout.activity_propsed)
@DarkStatusBarTheme(true)           //开启顶部状态栏图标、文字暗色模式
@DarkNavigationBarTheme(true)       //开启底部导航栏按钮暗色模式
@NavigationBarBackgroundColor(a = 255, r = 255, g = 255, b = 255)
public class PropsedActivity extends BaseAty {
    ...
    int pageCounte = 0;
    private LinearLayout propsedTuiban;
    private LinearLayout propsedYanqi;
    ...
    public void setEvents() {
        ...
        //退办
        propsedTuiban.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //1、使用Dialog、设置style
        ...
        //延期
        propsedYanqi.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //1、使用Dialog、设置style
                final Dialog dialog = new Dialog(me, R.style.DialogTheme);
    ...
    private void initView() {
        ...
        bottomChooseper2.setText("添加批示人");
        bottomWhrit.setHint("请输入拟办意见");
        ...
        propsedTuiban = findViewById(R.id.propsed_tuiban);
        propsedYanqi = findViewById(R.id.propsed_yanqi);
    }
}
