...
import com.lawe.starofadministration.fgt.shouwen_chuanyue.EntryDocumentFragment;
 ...
 * description : 收文传阅---公文承办
 **/
@Layout(R.layout.activity_undertake)
@DarkStatusBarTheme(true)           //开启顶部状态栏图标、文字暗色模式
@DarkNavigationBarTheme(true)       //开启底部导航栏按钮暗色模式
@NavigationBarBackgroundColor(a = 255, r = 255, g = 255, b = 255)
public class UndertakeActivity extends BaseAty {
    ...
    int pageCounte = 0;
    private LinearLayout undertakeTuiban;
    private LinearLayout undertakeYanqi;
    private LinearLayout undertakeBainhan;
    ...
    public void initDatas(JumpParameter parameter) {
        fragemnts.add(EntryDocumentFragment.newInstance());
    ...
    public void setEvents() {
        ...
        //退办
        undertakeTuiban.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //1、使用Dialog、设置style
                final Dialog dialog = new Dialog(me, R.style.DialogTheme);
                //2、设置布局
                View view = View.inflate(me, R.layout.pop_circulation_tuiban, null);
        ...
        //延期
        undertakeYanqi.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //1、使用Dialog、设置style
                final Dialog dialog = new Dialog(me, R.style.DialogTheme);
                //2、设置布局
                View view = View.inflate(me, R.layout.pop_circulation_yanqi, null);
                dialog.setContentView(view);
    ...
    private void initView() {
        ...
        bottomChooseper1.setText("添加办理人");
        bottomChooseper2.setText("添加协办人");
        bottomWhrit.setHint("请输入承办意见");
        ...
        undertakeTuiban = findViewById(R.id.undertake_tuiban);
        undertakeYanqi = findViewById(R.id.undertake_yanqi);
        undertakeBainhan = findViewById(R.id.undertake_bainhan);
    }
}
