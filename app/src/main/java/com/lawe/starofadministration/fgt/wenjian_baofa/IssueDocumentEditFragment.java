 ...
 * description : 文件报发---公文编辑
 **/

@Layout(R.layout.fgt_document_edit)
public class IssueDocumentEditFragment extends BaseFgt {
    ...
    public static IssueDocumentEditFragment newInstance() {
        return new IssueDocumentEditFragment();
    }
