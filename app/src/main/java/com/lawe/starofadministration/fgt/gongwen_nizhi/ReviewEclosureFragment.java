 ...
 * description : 公文审阅----附件目录
 */
@Layout(R.layout.fgt_enclosure)
public class ReviewEclosureFragment extends BaseFgt {
    ...
    public static ReviewEclosureFragment newInstance() {
        return new ReviewEclosureFragment();
    }
}
