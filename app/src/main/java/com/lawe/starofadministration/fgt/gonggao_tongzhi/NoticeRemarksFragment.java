 ...
 * description : 公告通知----备注信息
 */
@Layout(R.layout.fgt_remarks)
public class NoticeRemarksFragment extends BaseFgt {
    ...
    public static NoticeRemarksFragment newInstance() {
        return new NoticeRemarksFragment();
    }
}
