 ...
 * description : 文件报发---设置信息
 **/

@Layout(R.layout.fgt_issue_set_message)
public class IssueSetMessageFragment extends BaseFgt {
    ...
    public static IssueSetMessageFragment newInstance() {
        return new IssueSetMessageFragment();
    }
