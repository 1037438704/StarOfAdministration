 ...
 * description : 公文签发----附件目录
 */
@Layout(R.layout.fgt_enclosure)
public class LssueEclosureFragment extends BaseFgt {
    ...
    public static LssueEclosureFragment newInstance() {
        return new LssueEclosureFragment();
    }
}
