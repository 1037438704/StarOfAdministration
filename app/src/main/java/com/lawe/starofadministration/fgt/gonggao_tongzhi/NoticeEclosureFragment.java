 ...
 * description : 公告通知----附件目录
 */
@Layout(R.layout.fgt_enclosure)
public class NoticeEclosureFragment extends BaseFgt {
    ...
    public static NoticeEclosureFragment newInstance() {
        return new NoticeEclosureFragment();
    }
}
