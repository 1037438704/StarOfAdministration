 ...
 * description : 收文传阅---设置信息
 **/
@Layout(R.layout.fgt_entry_set_message)
public class EntrySetMessageFragment extends BaseFgt {
    ...
    public static EntrySetMessageFragment newInstance() {
        return new EntrySetMessageFragment();
    }
