 ...
 * description : 公文审阅----公文内容
 */
@Layout(R.layout.fgt_join_context)
public class ReviewContextFragment extends BaseFgt {
    ...
    public static ReviewContextFragment newInstance() {
        return new ReviewContextFragment();
    }
