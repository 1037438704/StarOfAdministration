 ...
 * description : 公文核发----公文内容
 */
@Layout(R.layout.fgt_join_context)
public class ApproveContextFragment extends BaseFgt {
    ...
    public static ApproveContextFragment newInstance() {
        return new ApproveContextFragment();
    }
}
