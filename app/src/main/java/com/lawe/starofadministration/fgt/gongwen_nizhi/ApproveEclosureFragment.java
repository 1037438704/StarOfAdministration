 ...
 * description : 公文核发----附件目录
 */
@Layout(R.layout.fgt_enclosure)
public class ApproveEclosureFragment extends BaseFgt {
    ...
    public static ApproveEclosureFragment newInstance() {
        return new ApproveEclosureFragment();
    }
}
