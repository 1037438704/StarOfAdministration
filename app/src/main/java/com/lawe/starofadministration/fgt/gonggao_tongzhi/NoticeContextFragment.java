 ...
 * description : 公告通知----公文内容
 */
@Layout(R.layout.fgt_join_context)
public class NoticeContextFragment extends BaseFgt {
    ...
    public static NoticeContextFragment newInstance() {
        return new NoticeContextFragment();
    }
}
