 ...
 * description : 公文核发---核发设置
 */
@Layout(R.layout.fgt_approve_setting)
public class ApproveSettingFragment extends BaseFgt {
    ...
    public static ApproveSettingFragment newInstance() {
