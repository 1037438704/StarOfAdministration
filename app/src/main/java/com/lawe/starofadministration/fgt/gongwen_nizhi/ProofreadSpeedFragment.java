 ...
 * description : 公文校对---办理进度
 */
@Layout(R.layout.fgt_join_speed)
public class ProofreadSpeedFragment extends BaseFgt {
    ...
    public static ProofreadSpeedFragment newInstance() {
        return new ProofreadSpeedFragment();
    }
